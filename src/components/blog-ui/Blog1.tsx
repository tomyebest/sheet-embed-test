// in production will serve as a layout component

import SubHero from "../hero-sections/SubPageHeroAlt";
...
export default function BlogContent() {
  return (
    <><SubHero title="Blog Post Example" description="This is a description about a blog post." buttonText="LEARN MORE" buttonHref="#" insightsHref=""/>
    <div className="bg-lightestBlue px-6 py-32 lg:px-8">
          <div className="mx-auto max-w-7xl sm: text-base leading-7 text-gray-700">
