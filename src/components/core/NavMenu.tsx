...
export default function NavMenu() {
  ...
  return (
    <header className="bg-darkBlue border-b border-lightOrange">
      <nav className="mx-auto flex max-w-7xl items-center justify-between py-4 px-8 lg:px-8" aria-label="Global">
        <div className="flex lg:flex-1">
          <a href="/" className="-m-1.5 p-1.5">
            <img className="h-12 w-auto" src={nav.logo.src} alt="" />
          </a>
        </div>
        ...
        <Popover.Group className="hidden lg:flex lg:gap-x-12">
          <Popover className="relative">
            <Popover.Button className="flex items-center gap-x-1 text-sm font-semibold leading-6 text-white">
              Online Tutoring
              <ChevronDownIcon className="h-5 w-5 flex-none text-lightOrange" aria-hidden="true" />
            </Popover.Button>
        ...
        <div className="hidden lg:flex lg:flex-1 lg:justify-end">
          <a href="#" className="text-sm font-semibold leading-6 text-gray-900">
            <GradientButton text="Contact us" link="/"/>
          </a>
        </div>
      </nav>
